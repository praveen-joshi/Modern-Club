<?php
	...
	include('conn.php');
	$query="select * from events where organizer_id={$_SESSION['organizer']}";
...
<body>
	...
	<section>
		...
		<div class="container">
			...
			{
				echo "<h2 class='text-center'> No Events is Register by you </h2>";
			}
			while($row=mysqli_fetch_assoc($res))
			{
				?>
			<a href="organizer_event_details.php?event=<?php echo $row['event_id']; ?>" class="text-dark">
				<div class='row shadow bg-light m-3 h-25'>
					<div class="col-md-4">
						<img src="<?php echo $row['image']; ?>" class="w-100 h-100" style="max-height:250px;">
					</div>
					<div class="col-md-8">
						...
						<span class="d-block"><?php echo $row['time']?></span>
					</div>
				</div>
			</a>
			<?php
