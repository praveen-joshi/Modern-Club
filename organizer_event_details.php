<?php
	...
	include('conn.php');
	$query="select * from events where event_id={$_GET['event']}";
...
<body>
	...
	<section>
		<h1 class="text-center heading mt-1 pt-3"><?php echo $event['name']." Registration"?></h1>
		<div class="container">
			<?php
				$query="SELECT * from users where id in (SELECT user_id from event_booking where event_id={$_GET['event']})";
