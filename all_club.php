...
<body>
	<section class="view lightnav" id='view_event_and_clubs'>
		...
		<div id="club_search_bar" class="bg-white event_search_bar shadow">
			<hr>
			<label><h2 class="	">Search :</h2></label>
			<input type="text" id="club_search" class="club_search" autocomplete="off">
			<hr>
		</div>

		<!-- here clubs will be added by the ajax -->
		<div class="club_box m-2" id="club_box">
